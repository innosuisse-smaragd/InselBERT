...
from transformers import AutoModelForQuestionAnswering, TrainingArguments, Trainer, default_data_collator, get_scheduler
import evaluate
...
for epoch in range(num_train_epochs):
    ...
    metrics = compute_metrics(
        start_logits, end_logits, validation_dataset, hf_dataset["validation"]
    )
    ...
    unwrapped_model.save_pretrained(constants.QA_MODEL_PATH, save_function=accelerator.save)
    if accelerator.is_main_process:
        tokenizer.save_pretrained(constants.QA_MODEL_PATH)
